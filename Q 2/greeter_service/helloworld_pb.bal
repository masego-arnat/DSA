...
public client class AssessmentBorrowBookResponseCaller {
...
public client class AssessmentCustomResponseCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendCustomResponse(CustomResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextCustomResponse(ContextCustomResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class AssessmentLocateBookResponseCaller {
    private grpc:Caller caller;
...
public client class AssessmentRemoveBookResponseCaller {
    private grpc:Caller caller;
...
public client class AssessmentRepeatedBookCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendRepeatedBook(RepeatedBook response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextRepeatedBook(ContextRepeatedBook response) returns grpc:Error? {
        return self.caller->send(response);
    }
